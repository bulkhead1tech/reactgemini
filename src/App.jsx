...
function App() {
  ...
  return (
    <>
    <div className='flex flex-col p-2 bg-black h-screen w-screen bg-gradient-to-t from-teal-950 backdrop-blur-lg via-transparent to-transparent'>
     ...
     <div className='flex w-full h-full flex-col lg:w-full lg:h-full lg:flex-row'>
  ...
  Secure....
     ...
     <div className='h-1/2 w-full flex flex-col gap-y-15 gap-x-5 md:h-full md:w-1/2 lg:h-full lg:w-1/2 lg:p-10  justify-center items-center'>
     <div className='h-1/3 w-full px-5 py-1 text-red-500 flex items-center justify-center border-slate-400 border-2 border-solid text-4xl'>
     {first!=""?<>{first}</>:<>{"Loading..."}</>}
     </div>
